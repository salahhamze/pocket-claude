...
The gosl of this repo is to have full control of Claude Code through Telegram without ever having to open the terminal after the initial sdtup. Sessions persist thanks to tmux. 
